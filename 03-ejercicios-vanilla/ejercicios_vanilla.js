...
let numero13 = parseInt(prompt("ingresa tu numero"), 10);
let dato = (numero13 = typeof Number) => {
   if (numero13 == undefined) return console.error("No ingresaste un número");
   if (numero13 == 1) return console.warn(`No puedes usar el numero 1 `);
   if (Math.sign(numero13) == -1) return console.warn(`No puedes usar el numero negativos `);
